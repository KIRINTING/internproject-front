...
export class MentorService {
    ...
    getMyStudents(): Observable<any[]> {
        return this.http.get<any[]>(`${this.apiUrl}/mentor/students`);
    }
    ...
    getAssessments(studentId: string): Observable<Assessment[]> {
        return this.http.get<Assessment[]>(`${this.apiUrl}/assessments?student_id=${studentId}&evaluator_type=mentor`);
    }
}
